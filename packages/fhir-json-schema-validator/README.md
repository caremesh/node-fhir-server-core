...
```shell
yarn add @caremesh/fhir-json-schema-validator
```

## Arguments

`@caremesh/fhir-json-schema-validator` exports a single class called JSONSchemaValidator. This class takes two optional
