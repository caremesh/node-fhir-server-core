...
```javascript
const { resolveSchema } = require('@caremesh/node-fhir-server-core');
...
```javascript
const { ServerError } = require('@caremesh/node-fhir-server-core');
// In patient service
...
```javascript
const { loggers } = require('@caremesh/node-fhir-server-core');
...
```javascript
const { container } = require('@caremesh/node-fhir-server-core').loggers;
...
```javascript
const { initialize, loggers } = require('@caremesh/node-fhir-server-core');
const logger = loggers.get('default');
