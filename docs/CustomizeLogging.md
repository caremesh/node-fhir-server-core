...
If you simply need to use the core fhir server `winston` Container you can do so by requiring it from `@caremesh/fhir-server-core`
...
const { initialize } = require('@caremesh/node-fhir-server-core');
